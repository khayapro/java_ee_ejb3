...
public class PublicPostingMessageBean implements MessageListener {

    /**
     * Handling all public messages received.
     * @param message - private message
     */
    @Override
    public void onMessage(Message message) {
        try {
            final TextMessage publicMessage = (TextMessage) message;
            System.out.println("public post received : message - " + publicMessage.getText());
